...
class INVENTOR_API SoMField : public SoField {
  ...
  public:
	...
	// Sets index of changed field
	void         setIndex(int theIndex) { changedIndex = theIndex; }
	...
	SbBool      getChangedIndexString(int &thisIndex, SbString &valueString);
  ...
  protected:
    ...
    int         changedIndex; // Index of changed value
    // Constructor
    SoMField();
