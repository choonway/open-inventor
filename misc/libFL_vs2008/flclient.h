...
__declspec(dllexport) FLcontext flCreateContext(
...
__declspec(dllexport) FLfontNumber flCreateFont(
...
__declspec(dllexport) void flDestroyFont(
    FLfontNumber                   /* fn */
);
...
__declspec(dllexport) void flFreeBitmap(
    FLbitmap *                     /* bitmapPtr */
);
...
__declspec(dllexport) void flFreeOutline(
    FLoutline *                     /* outline */
);
...
__declspec(dllexport) FLbitmap *flGetBitmap(
    FLfontNumber                   /* fn */, 
    GLuint                         /* c */
);
...
__declspec(dllexport) FLcontext flGetCurrentContext(
    void
);

__declspec(dllexport) GLboolean flMakeCurrentContext(
    FLcontext                      /* ctx */
);

__declspec(dllexport) FLfontNumber flGetCurrentFont(
    void
);
...
__declspec(dllexport) FLoutline *flGetOutline(
    FLfontNumber                   /* fn */, 
    GLuint                         /* c */
);
...
__declspec(dllexport) GLboolean flMakeCurrentFont(
    FLfontNumber                   /* fn */
);
...
__declspec(dllexport) void flSetHint(
    GLuint                         /* hint */, 
    GLfloat                        /* hintValue */
);
