...
#endif
#define MACHINE_WORD_FORMAT     DGL_LITTLE_ENDIAN
#define MACHINE_FLOAT_FORMAT    DGL_LITTLE_IEEE
#define signed                  /* WIN32 default is signed chars */
...
#if MACHINE_FLOAT_FORMAT == DGL_LITTLE_IEEE

#define DGL_HTON_FLOAT(t,f)     \
        {                       \
                float _from = f,_to;    \
                ((char *)&_to)[0] = ((char *)&_from)[3];        \
                ((char *)&_to)[1] = ((char *)&_from)[2];        \
