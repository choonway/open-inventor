...
//
// Description:
//    Returns the recently changed value string and index.
//
// Use: public

SbBool
SoMField::getChangedIndexString(int &thisIndex, SbString &valueString)
//
////////////////////////////////////////////////////////////////////////
{
    if(changedIndex >= 0)
	{
        thisIndex = changedIndex;
        get1(thisIndex, valueString);
		return TRUE;
	}
	return FALSE;
}
