...
//
// Description:
//    This resets all changed status variables to the default values
//
// Use: private
void
SoGroup::resetChangedStatus()
//
////////////////////////////////////////////////////////////////////////
{
    changedChild=NULL;
...
//
// Description:
//    This returns the changed child node
//
// Use: public
SoNode *
SoGroup::getChangedChild()
//
////////////////////////////////////////////////////////////////////////
{
    return changedChild;
...
//
// Description:
//    This returns the index of the changed child
//
// Use: public
int
SoGroup::getChangedIndex()
//
////////////////////////////////////////////////////////////////////////
{
    return changedIndex;
...
//
// Description:
//    This returns the type of change (see SoGroupChangeType in SoGroup.h)
//
// Use: public
int
SoGroup::getChangedType()
//
////////////////////////////////////////////////////////////////////////
{
    return changedType;
...
////////////////////////////////////////////////////////////////////////
{
	...
	{
		changedChild=child;
		changedIndex=newChildIndex;
        changedType=GROUP_INSERTCHILD;
...
////////////////////////////////////////////////////////////////////////
{
	changedChild=NULL;
	changedIndex=-1;
	changedType=GROUP_REMOVEALLCHILDREN;
    children->truncate(0);
    resetChangedStatus();
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (index >= 0)
	{
        changedChild=newChild;
	    changedIndex=index;
	    changedType=GROUP_REPLACECHILD;
