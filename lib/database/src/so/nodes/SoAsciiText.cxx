...
#else
	gluTessCallback(tobj, GLU_TESS_BEGIN, (void (__stdcall *)(void))glBegin);
	gluTessCallback(tobj, GLU_TESS_END, (void (__stdcall *)(void))glEnd);
	gluTessCallback(tobj, GLU_TESS_VERTEX, (void (__stdcall *)(void))glVertex2fv);
	gluTessCallback(tobj, GLU_TESS_ERROR,
			(void (__stdcall *)(void))MyOutlineFontCache::errorCB);
#endif
    }
...
////////////////////////////////////////////////////////////////////////
{
    ...
    SbVec3f min1(boxMin[0], boxMin[1], 0);
    SbVec3f max1(boxMax[0], boxMax[1], 0);
    box.extendBy(min1);
    box.extendBy(max1);
}
...
////////////////////////////////////////////////////////////////////////
{
	...
	gluTessCallback(tobj, GLU_ERROR,
			(void (*)())MyOutlineFontCache::errorCB);
#else
	gluTessCallback(tobj, GLU_TESS_BEGIN, (void (__stdcall *)(void))SoAsciiText::beginCB);
	gluTessCallback(tobj, GLU_TESS_END, (void (__stdcall *)(void))SoAsciiText::endCB);
	gluTessCallback(tobj, GLU_TESS_VERTEX, (void (__stdcall *)(void))SoAsciiText::vtxCB);
	gluTessCallback(tobj, GLU_TESS_ERROR,
			(void (__stdcall *)(void))MyOutlineFontCache::errorCB);
#endif
    }
