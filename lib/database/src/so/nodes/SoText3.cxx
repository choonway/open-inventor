...
////////////////////////////////////////////////////////////////////////
{
...
#else
	gluTessCallback(tobj, (GLenum)GLU_TESS_BEGIN, (void (__stdcall *)(void))glBegin);
#endif
#ifndef WIN32
	gluTessCallback(tobj, (GLenum)GLU_END, (void (*)())glEnd);
#else
	gluTessCallback(tobj, (GLenum)GLU_TESS_END, (void (__stdcall *)(void))glEnd);
#endif
#ifndef WIN32
	gluTessCallback(tobj, (GLenum)GLU_VERTEX, (void (*)())glVertex2fv);
#else
	gluTessCallback(tobj, (GLenum)GLU_TESS_VERTEX, (void (__stdcall *)(void))glVertex2fv);
#endif
#ifndef WIN32
	...
	gluTessCallback(tobj, (GLenum)GLU_TESS_ERROR,
			(void (__stdcall *)(void))SoOutlineFontCache::errorCB);
#endif
    }
...
////////////////////////////////////////////////////////////////////////
{
    ...
    // Front and back are straightforward:
    if (prts & FRONT) {
	SbVec3f min1(boxMin[0], boxMin[1], firstZ);
	SbVec3f max1(boxMax[0], boxMax[1], firstZ);
	box.extendBy(min1);
	box.extendBy(max1);
    }
    if (prts & BACK) {
	SbVec3f min1(boxMin[0], boxMin[1], lastZ);
	SbVec3f max1(boxMax[0], boxMax[1], lastZ);
	box.extendBy(min1);
	box.extendBy(max1);
    }
    //
...
////////////////////////////////////////////////////////////////////////
{
	...
	gluTessCallback(tobj, (GLenum)GLU_ERROR,
			(void (*)())SoOutlineFontCache::errorCB);
#else
	gluTessCallback(tobj, (GLenum)GLU_TESS_BEGIN, (void (__stdcall *)(void))SoText3::beginCB);
	gluTessCallback(tobj, (GLenum)GLU_TESS_END, (void (__stdcall *)(void))SoText3::endCB);
	gluTessCallback(tobj, (GLenum)GLU_TESS_VERTEX, (void (__stdcall *)(void))SoText3::vtxCB);
	gluTessCallback(tobj, (GLenum)GLU_TESS_ERROR,
			(void (__stdcall *)(void))SoOutlineFontCache::errorCB);
#endif
    }
